...
![2.アプリ起動ブラウザ_2023-11-26 0.25.55](/RaiseTech/images/2.アプリ起動ブラウザ_2023-11-26 0.25.55.png)
...
![1.アプリ起動_ 2023-11-26 0.23.06](/RaiseTech/images/1.アプリ起動_ 2023-11-26 0.23.06.png)
...
![3.puma停止2023-11-26 0.28.34](/RaiseTech/images/3.puma停止2023-11-26 0.28.34.png)

4. APサーバーpuma停止後のブラウザ

![4.puma停止後のブラウザ_2023-11-26 0.30.31](/RaiseTech/images/4.puma停止後のブラウザ_2023-11-26 0.30.31.png)

5. APサーバーpuma再起動 `rails s`コマンドでアプリケーションのサーバーを起動

![5.puma再起動_ 2023-11-26 0.31.58](/RaiseTech/images/5.puma再起動_ 2023-11-26 0.31.58.png)

6. puma再起動後ブラウザ確認。`GET` `POST`共に問題ない。

![6.puma再起動後_2023-11-26 1.25.43](/RaiseTech/images/6.puma再起動後_2023-11-26 1.25.43.png)
...
![7.mysqlバージョン確認_ 2023-11-26 1.39.18](/RaiseTech/images/7.mysqlバージョン確認_ 2023-11-26 1.39.18.png)
...
![8.DBサーバー停止後のAPサーバー再起動_ 2023-11-26 1.48.11](/RaiseTech/images/8.DBサーバー停止後のAPサーバー再起動_ 2023-11-26 1.48.11.png)
...
![９.DBサーバー停止後のブラウザ画面_2023-11-26 1.46.55](/RaiseTech/images/９.DBサーバー停止後のブラウザ画面_2023-11-26 1.46.55.png)
...
![10.MySQL状態確認と再起動_2023-11-26 2.09.29](/RaiseTech/images/10.MySQL状態確認と再起動_2023-11-26 2.09.29.png)
...
![11.DBサーバー再起動後の確認スクリーンショット 2023-11-26 2.21.57](/RaiseTech/images/11.DBサーバー再起動後の確認スクリーンショット 2023-11-26 2.21.57.png)
